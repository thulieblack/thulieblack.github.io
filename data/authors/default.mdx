...
<Callout>
  ⚡ The future is open source, and companies, users, and orgs need to invest in and support
  open-source projects and maintainers. By providing funding, we can ensure the growth and
  sustainability of open-source projects, paving the way for a more collaborative and innovative
  future.
</Callout>
